...
interface HKWTextView_Plugins
{
    ...
    [Export("setShouldRejectAutocorrectInsertions:")]
...
interface HKWTextView_Extras
{
    ...
    [Export("setDisableVerticalScrolling:")]
...
interface HKWChooserViewProtocol
{
    ...
    NSObject ChooserViewWithFrame(CGRect frame, UITableViewSource @delegate);
    ...
    NSObject ChooserViewWithFrame(CGRect frame, UITableViewSource @delegate, UITableViewSource dataSource);
